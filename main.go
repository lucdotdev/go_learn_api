...
func main() {
	...
	books = append(books, Book{ID: "2", Title: "Book Tweo", Author: &Author{FirstName: "Doe", LastName: "doe"}})
	books = append(books, Book{ID: "3", Title: "Book Three", Author: &Author{FirstName: "John", LastName: "doe"}})
